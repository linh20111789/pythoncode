...
pos_im_path = r"./images"  # This is the path of our positive input dataset
# define the same for negatives
neg_im_path = r"./neg"

# read the image files:
pos_im_listing = os.listdir(
    pos_im_path)  # it will read all the files in the positive image path (so all the required images)
...
#model = LinearSVC()
#model = SVC(kernel='sigmoid',gamma='auto',C=1,max_iter=-1,tol=1e-4,coef0=1)
...
# Save the model:
# %% Save the Model
joblib.dump(SVC, 'model_name.npy')
