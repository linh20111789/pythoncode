...
linesData.append("Max Volume (Date) \t" + List2020AnalysisData[1].rjust(10) + List2021AnalysisData[1].rjust(20) + str(List2020AnalysisData[0]+List2021AnalysisData[0]).rjust(20) +endline)
linesData.append("Min Volume (Date) \t" + List2020AnalysisData[3].rjust(10) + List2021AnalysisData[3].rjust(20)+ str(List2020AnalysisData[2]+List2021AnalysisData[2]).rjust(20) +endline)
linesData.append("Lowest Open (Date) \t" + List2020AnalysisData[5].rjust(10)  + List2021AnalysisData[5].rjust(20) + str(List2020AnalysisData[4]+List2021AnalysisData[4]).rjust(20) +endline)
linesData.append("Highest Close (Date) \t" + List2020AnalysisData[7].rjust(10)  + List2021AnalysisData[7].rjust(20) + str(List2020AnalysisData[6]+List2021AnalysisData[6]).rjust(20) +endline)
linesData.append("Highest Monthly \nAverage (Month) \t" + List2020AnalysisData[8].rjust(10)  + List2021AnalysisData[8].rjust(20) + str(List2020AnalysisData[9]+List2021AnalysisData[9]).rjust(20) +endline)
linesData.append("Lowest Monthly \nAverage (Month) \t" + List2020AnalysisData[10].rjust(10)  + List2021AnalysisData[10].rjust(20) + str(round(List2020AnalysisData[11]+List2021AnalysisData[11],6)).rjust(20) +endline)
linesData.append("Annual Average \t\t" + str(List2020AnalysisData[12]).rjust(10) +  str(List2021AnalysisData[12]).rjust(20) + str(List2020AnalysisData[12]+List2021AnalysisData[12]).rjust(20) +endline)
